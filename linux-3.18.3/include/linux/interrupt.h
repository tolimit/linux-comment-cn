...
#define IRQF_TRIGGER_MASK	(IRQF_TRIGGER_HIGH | IRQF_TRIGGER_LOW | \
				 IRQF_TRIGGER_RISING | IRQF_TRIGGER_FALLING)		/* 触发掩码 */
 ...
 */
 /* 用于中断服务例程flags */
#define IRQF_DISABLED		0x00000020		/* 处理这个中断服务例程时禁止其他IRQ中断 */
#define IRQF_SHARED		0x00000080			/* 允许多个设备之间共享IRQ */
#define IRQF_PROBE_SHARED	0x00000100		
#define __IRQF_TIMER		0x00000200		/* 此中断服务例程作为定时器中断 */
#define IRQF_PERCPU		0x00000400			/* 只能在同一个CPU上处理 */
#define IRQF_NOBALANCING	0x00000800		/* 此中断服务例程不进行中断负载均衡 */
#define IRQF_IRQPOLL		0x00001000		
#define IRQF_ONESHOT		0x00002000
#define IRQF_NO_SUSPEND		0x00004000
#define IRQF_FORCE_RESUME	0x00008000
#define IRQF_NO_THREAD		0x00010000		/* 不进行线程化 */
...
struct irqaction {
	...
	/* 设备ID，同个驱动程序可能需要负责多个设备，用这个设备ID进行区分 */
	void			*dev_id;
...
struct tasklet_struct
{
	...
	unsigned long state;  			/* 此tasklet状态，分为 */
